...
<button type="button"  onclick="window.location='{{ route('tutorAcad.practicas.show', $asignacion->id) }}'" class="btn btn-primary" >
                        ...
                        <table class="table table-striped inline-table">
                            ...
                            <tr>
                                ...
                                <td class="vertical-center" scope="row" style="float:right;">
                                    <input id="criterio[{{$i}}][valor]" type="number" min="1" max="10" name="criterio[{{$i}}][valor]" @if(isset($notaTemp)) value="{{  $notaTemp }}"
                                        @endif class="form-control" required style="width: 100px; text-align:center" disabled></td>
                            </tr>
                            <?php $i += 1 ?> @endforeach
                        </table>
                    </div>
