                        ...
                        <tr>
                            ...
                            <td class="vertical-center" scope="row">
                                <div class="btn-group btn-group-justified">
                                    <button class="btn btn-info" type="button" title="Ver asignación de prácticas" onclick="window.location='{{ route('tutorInst.practicas.show', $asignacion->id) }}'"><i
                                        class="fa fa-eye"></i></button>
                                    <button class="btn btn-info" type="button" title="Porfolio de evidencias"  onclick="window.location='{{ route('tutorInst.practicas.evidencias', $asignacion->id) }}'"><i
