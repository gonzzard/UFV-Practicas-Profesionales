...
<div class="row">
    <div class="col-md-10">
        <h2>Listado de tutores institucionales</h2>
    </div>
    <div class="col-md-2">
        <button class="btn btn-success float-right" title="Nuevo tutor institucional" type="button" onclick="window.location='{{ route('tutoresInstitucionales.create') }}'"><i class="fas fa-plus-circle"></i> Nuevo tutor</button>
    </div>
</div>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
                            ...
                            <td class="vertical-center" scope="row">
                                <form method="POST" action='{{ route('tutoresInstitucionales.show', $user->id) }}' onsubmit="return confirm('Confirmar eliminación del usuario');">
                                    ...
                                    <div class="btn-group btn-group-justified">
                                        <button class="btn btn-info" type="button" title="Ver tutor institucional" onclick="window.location='{{ route('tutoresInstitucionales.show', $user->id) }}'"><i
                                                class="fa fa-eye"></i></button>
                                        <button class="btn btn-info" type="button" title="Editar tutor institucional" onclick="window.location='{{ route('tutoresInstitucionales.edit', $user->id) }}'"><i
            ...
            @else
            <div style="text-align:center">No hay tutores institucionales.</div>
            @endif
        </div>
    </div>
</div>
