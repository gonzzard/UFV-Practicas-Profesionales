...
<div class="row">
    <div class="col-md-12">
        <h2>Ver criterio evaluación institución</h2>
    </div>
</div>
...
<button type="button"  onclick="window.location='{{ route('criteriosEncuesta.index', $criterio->practica->id) }}'" class="btn btn-primary" >
