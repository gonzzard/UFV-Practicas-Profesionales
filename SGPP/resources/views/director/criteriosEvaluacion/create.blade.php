...
<div class="row">
    <div class="col-md-12">
        <h2>Nuevo criterio evaluación {{$practica->criterio}}</h2>
    </div>
</div>
...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-md-6">
            <form method="POST" action="{{ route('criteriosEvaluacion.store') }}">
                @csrf
                ...
                <span class="invalid-feedback" role="alert">
                    ...
                    <input id="ponderacion" type="number" min="1" max="{{$cantidadPonderadaRestante}}" class="form-control{{ $errors->has('ponderacion') ? ' is-invalid' : '' }}" name="ponderacion"
                        value="{{ old('ponderacion') }}" required autofocus step="1" style="max-width: 100px; text-align: center"> 
