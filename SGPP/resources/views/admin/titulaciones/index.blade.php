...
<div class="row">
    ...
    <div class="col-md-3">
        <button class="btn btn-success float-right" type="button" onclick="window.location='{{ route('titulaciones.create') }}'" title="Nueva titulación"><i class="fas fa-plus-circle"></i> Nueva titulación</button>
    </div>
</div>
                            ...
                            <div class="row">
                                <form method="POST" action='{{ route('titulaciones.show', $tit->id) }}' onsubmit="return confirm('Confirmar eliminación del usuario');">
                                    ...
                                    <div class="btn-group btn-group-justified">
                                        <button class="btn btn-info" type="button" title="Ver titulación" onclick="window.location='{{ route('titulaciones.show', $tit->id) }}'"><i class="fa fa-eye"></i></button>
                                        <button class="btn btn-info" type="button" title="Editar titulación" onclick="window.location='{{ route('titulaciones.edit', $tit->id) }}'"><i
