                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="docIdentificacion" type="text" class="form-control{{ $errors->has('docIdentificacion') ? ' is-invalid' : '' }}" name="docIdentificacion" value="{{ old('docIdentificacion') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                @foreach($roles as $role)
                                    <input type="checkbox" name="role[]" value="{{$role->id}}">{{$role->nombre}}<br>
                                @endforeach
                            </div>
                        </div>
