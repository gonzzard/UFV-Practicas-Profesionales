...
class UserController extends Controller {
    ...
    public function index() {
        ...
        $users = User::with('roles')->paginate(8); // Todos los usuarios más la información relacionada de la tabla roles
    ...
    public function show($id) {
        $user = User::where('id', $id)->with('roles')->get(); // Usuario con id $id, más la información relacionada de la tabla roles
    ...
    public function update(Request $request, $id) {
        ...
        Session::flash('user.update', 'Información del usuario ' . $user->name . ' actualizada');
        return redirect('user');
    }
